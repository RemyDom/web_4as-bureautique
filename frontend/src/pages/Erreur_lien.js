        ...
        <div className="ErreurLien_container">
            ...
            <div className="ErreurLien_container_parts">
                ...
                <div className="ErreurLien_Part2">
                    ...
                    <svg className="ErreurLien_svg_principal" width="647" height="572" viewBox="0 0 647 572" fill="none" >
                    ...
                    <svg className="ErreurLien_svg2"  width="43" height="57" viewBox="0 0 43 57" fill="none" >
                        <path d="M42.2 23.7C42.2 37.7 35.6 56.4 25.2 56.4C14.7 56.4 0.5 37.7 0.5 23.7C0.5 9.7 14.7 0.5 25.2 0.5C35.6 0.5 42.2 9.7 42.2 23.7Z" fill="#c22a1f" />
                    </svg>

                    <svg className="ErreurLien_svg3" width="28" height="25" viewBox="0 0 28 25" fill="none" >
                        <path d="M27.9 9.3C27.9 15.4 19.7 24.4 12.8 24.4C5.8 24.4 0 15.4 0 9.3C0 3.2 5.8 0 12.8 0C19.7 0 27.9 3.2 27.9 9.3Z" fill="#c22a1f" />
                    </svg>
